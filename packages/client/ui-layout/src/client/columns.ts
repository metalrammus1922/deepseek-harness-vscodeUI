...
/** Right AI-chat panel drag clamp floor. */
export const DETAILS_MIN = 340
/** Right AI-chat panel drag clamp ceiling. */
export const DETAILS_MAX = 640
/** Right AI-chat panel width before any user drag. */
 ...
 * @param details - right AI-chat panel width preference in px (0 = closed).
