...
export const zh = {
  ...
  'composer.fileRefs': '文件引用',
  'composer.removeFileRef': '移除引用',
  'composer.pinFileRef': '固定当前文件，切换标签时保留',
  'composer.unpinFileRef': '取消固定，跟随当前文件',
...
export const en = {
  ...
  'composer.fileRefs': 'File references',
  'composer.removeFileRef': 'Remove reference',
  'composer.pinFileRef': 'Pin the current file; keep it across tab switches',
  'composer.unpinFileRef': 'Unpin; follow the current file again',
